...
const IntroductionComponent = () => {
  return (
    <>
      ...
      <div className="w-full px-40 bg-zinc-800 font-sourceCode pb-16">
        <div className="bg-zinc-200 py-24 px-24 border-8 border-zinc-500 rounded-md grid justify-items-center">
