...
const ProjectCard = ({ project, isActive, index, activeIndex }) => {
  return (
    <motion.article
      className="group bg-zinc-700 rounded-lg shadow-lg hover:shadow-2xl flex flex-col w-full min-w-[300px] max-w-[400px] md:min-w-0 md:max-w-none mx-auto"
    ...
    >
      ...
      <div className="p-4 md:p-6 flex flex-col flex-grow">
        ...
        <p className="text-zinc-300 mb-4 md:mb-5 leading-relaxed text-sm md:text-base">
          {project.description}
        </p>
